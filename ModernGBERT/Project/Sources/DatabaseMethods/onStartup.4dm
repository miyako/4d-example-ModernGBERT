...
$folder:=$homeFolder.folder("ModernGBERT_134M")
$path:="ModernGBERT_134M-Q8_0.gguf"
$URL:="keisuke-miyako/ModernGBERT_134M-gguf-q8_0"
...
$folder:=$homeFolder.folder("ModernGBERT")
$path:="ModernGBERT_134M-onnx-int8"
$URL:="keisuke-miyako/ModernGBERT_134M-onnx-int8"
